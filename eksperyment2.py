...
clf = [
    ...
    MySEA(base_estimator=KNeighborsClassifier(n_neighbors=2)),
    MySEA(base_estimator=DecisionTreeClassifier(random_state=117)),
]
...
np.save('2results3', scores3)
"""

scores1 = np.load('2results1.npy')
scores2 = np.load('2results2.npy')
scores3 = np.load('2results3.npy')
...
plt.suptitle('SEA (GaussianNB vs KNeighborsClassifier vs DecisionTreeClassifier)')
plt.show()
